# wordingo documentation

| File | What it covers |
|------|----------------|
| [overview.md](overview.md) | Introduction, key features, design principles |
| [getting-started.md](getting-started.md) | Installation, quick start, create/open/save |
| [content-api.md](content-api.md) | Paragraphs, runs, formatting, named styles, lists, hyperlinks |
| [tables-and-images.md](tables-and-images.md) | Tables (grid + builder), images (add, size, DPI) |
